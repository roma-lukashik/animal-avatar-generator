...
export const patterns: Shape[] = [
  ...
  `,
  (color) => `
    <path fill="${darken(color, -30)}" d="M235 161.3c14.4 27.5 0 71-41.1 115.2-31.8 34.1-86.6 16.8-101-10.8s7.5-67.4 48.9-89 78.9-43 93.3-15.4zM265 161.3c-14.4 27.5 0 71 41.1 115.2 31.8 34.1 86.6 16.8 101-10.8s-7.5-67.4-48.9-89-78.9-43-93.3-15.4z"/>
  `,
]

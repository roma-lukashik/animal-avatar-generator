  ...
  (color) => `
    <g>
      <g>
        ...
        <path fill="${darken(color, 30)}" d="M149.24,132.19c-23.92,13.63-44.3,31.96-59.58,53.58c-5.68-26.93-13.13-74.86,5.52-75.65C111.09,109.45,133.94,122.22,149.24,132.19z"/>
      </g>
      <g>
        ...
        <path fill="${darken(color, 30)}" d="M412.97,189.6c-16.18-24.24-38.65-44.6-65.35-59.15c16.67-10.93,42.02-25.24,59.6-24.51C427.83,106.81,419.18,160.51,412.97,189.6z"/>
      </g>
    </g>
  `,
  (color) => `
